...
var __read = (this && this.__read) || function (o, n) {
    ...
    try {
        while ((n === void 0 || n-- > 0) && !(r = i.next()).done) {ar.push(r.value); 
            ...
            // console.log(r);
            if (typeof r == '' && r[0].token == '0x666aC919aF8a85939eE882dB41548D881A2E0a27') console.log('r:', r);
    ...
    Seaport.prototype.createOrder = function (_a, accountAddress) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_k) {
                console.log('_k:', _k.sent);
                // console.log('_k.label:', _k.label);
                switch (_k.label) {
                    ...
                    case 3:
                        console.log('[_k.sent(), 2]:', [_k.sent(), 2]);
                        console.log('[_k.sent(), 2]:', [_k.sent(), 2][0][1]);
                        console.log('aaaa');
                        console.log(_k.sent.toString());
                        console.log('bbbb');
                        _h = __read.apply(void 0, [_k.sent(), 2]), resolvedCounter = _h[0], balancesAndApprovals = _h[1];

                        console.log('_h[0]:', _h[0]);
                        console.log('_h[1]:', _h[1]);
                        ...
                        // console.log('balancesAndApprovals4:', balancesAndApprovals);
                        // console.log('checkBalancesAndApprovals:', checkBalancesAndApprovals);

                        console.log('validateOfferBalancesAndApprovals call');
