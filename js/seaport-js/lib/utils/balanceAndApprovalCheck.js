...
var findBalanceAndApproval = function (balancesAndApprovals, token, identifierOrCriteria) {
    // console.log('balancesAndApprovals2:', balancesAndApprovals);
    // console.log('token:', token);
    // console.log('identifierOrCriteria:', identifierOrCriteria);
    ...
    // console.log('balanceAndApproval:', balanceAndApproval);
...
var validateOfferBalancesAndApprovals = function (_a) {
    ...
    // console.log('throwOnInsufficientBalances:', throwOnInsufficientBalances);
    // console.log('insufficientBalances.length:', insufficientBalances.length);
    if (throwOnInsufficientBalances && insufficientBalances.length > 0) {
        throw new Error("The offerer does not have the amount needed to create or fulfill3.");
    }
...
var validateBasicFulfillBalancesAndApprovals = function (_a) {
    ...
    if (insufficientBalances.length > 0) {
        throw new Error("The fulfiller does not have the balances needed to fulfill2.");
    }
    return insufficientApprovals;
};
